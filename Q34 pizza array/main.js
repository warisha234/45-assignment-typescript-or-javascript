...
//  of printing just the name of the pizza.
...
var fvrtPizza = ['Chessy tikka', 'fajita,', 'pepperoni,'];
for (var _i = 0, fvrtPizza_1 = fvrtPizza; _i < fvrtPizza_1.length; _i++) {
    var pizza = fvrtPizza_1[_i];
    console.log("I like ".concat(pizza, " pizza"));
}
// print a msg out side of loop
